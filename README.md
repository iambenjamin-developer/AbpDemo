...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9fe33bb0-963f-4279-b4ab-2e75cc9a2d2f
```

> `9fe33bb0-963f-4279-b4ab-2e75cc9a2d2f` is the password of the certificate, you can change it to any password you want.
...
Run `AbpDemo.DbMigrator` to create the initial database. This should be done in the first run. It is also needed if a new database migration is added to the solution later.

### Solution structure

This is a layered monolith application that consists of the following applications:

* `AbpDemo.DbMigrator`: A console application which applies the migrations and also seeds the initial data. It is useful on development as well as on production environment.
